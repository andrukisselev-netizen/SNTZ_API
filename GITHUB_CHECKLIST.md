...
- В репозиторий попадает только **.ccx** (плагин Photoshop), исходники UXP — в NewAPI/sntz-imagen_GEMv1.1/UXP
...
- Папка `UXP/` удалена из SNTZ_API (исходники — в sntz-imagen_GEMv1.1)
